...
class ChecklistViewWidget extends StatefulWidget {
  ...
  static String routeName = 'ChecklistView';
  static String routePath = '/checklistView';
                              ...
                              children: [
                                KeepAliveWidgetWrapper(
                                  builder: (context) =>
                                      FutureBuilder<ApiCallResponse>(
                                    future:
                                        MasterGroup.getChecklistViewCall.call(
                                      token: FFAppState().token,
                                                ...
                                                builder: (context) {
                                                  final checkListResult =
                                                      functions
                                                              .searchFilter(
                                                                  getJsonField(
                                                                    columnGetChecklistViewResponse
                                                                        .jsonBody,
                                                                    r'''$.result''',
                                                                  ),
                                                                  _model
                                                                      ...
                                                                      if ((_model
                                                                        ...
                                                                        await showDialog(
                                                                          ...
                                                                          builder:
                                                                            ...
                                                                            return AlertDialog(
                                                                              title: Text('Alert'),
                                                                              content: Text((_model.checkListResponse?.bodyText ?? '')),
                                                                              actions: [
                                                                                TextButton(
                                                                                  onPressed: () => Navigator.pop(alertDialogContext),
                                                                                  child: Text('Ok'),
                                                                        ...
                                                                        builder:
                                                                          ...
                                                                          return AlertDialog(
                                                                            title:
                                                                                Text('Alert'),
                                                                            content:
                                                                                Text((_model.updateAlertResponse?.bodyText ?? '')),
                                                                            actions: [
                                                                              TextButton(
                                                                                onPressed: () => Navigator.pop(alertDialogContext),
                                                                                child: Text('Ok'),
                                ...
                                KeepAliveWidgetWrapper(
                                  builder: (context) =>
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      final columnGetChecklistViewCameraResponse =
                                          snapshot.data!;
                                        ...
                                        children: [
                                                ...
                                                Align(
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child: InkWell(
                                                      ...
                                                      onTap: () async {
                                                        await launchURL(
                                                            'https://api.app.master.buildint.co/api/checklist/exportExcel/camera-installation');
                                                      },
                                                      child: FaIcon(
                                                        FontAwesomeIcons
                                                            .solidFileExcel,
                                          ...
                                          Expanded(
                                            child: Padding(
                                              ...
                                              child: Builder(
                                                builder: (context) {
                                                  final checkListCameraResult =
                                                      functions
                                                              .searchFilter(
                                                                  getJsonField(
                                                                    columnGetChecklistViewCameraResponse
                                                                        .jsonBody,
                                                                    r'''$.result''',
                                                                  ),
                                                                  _model
                                                                ...
                                                                onTap:
                                                                  ...
                                                                  var confirmDialogResponse =
                                                                      await showDialog<
                                                                          ...
                                                                          false;
                                                                  if (confirmDialogResponse) {
                                                                    _model.deleteChecklistResponse2 =
                                                                        await MasterGroup
