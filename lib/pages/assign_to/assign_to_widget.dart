...
class AssignToWidget extends StatefulWidget {
  ...
  @override
  State<AssignToWidget> createState() => _AssignToWidgetState();
}

class _AssignToWidgetState extends State<AssignToWidget> {
  late AssignToModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AssignToModel());
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Expanded(
                        child: TextFormField(
                          controller: _model.contactNumTextController,
                          ...
                          validator: _model.contactNumTextControllerValidator
                              .asValidator(context),
                          inputFormatters: [
                              ...
                              await showDialog(
                                ...
                                builder: (alertDialogContext) {
                                  return AlertDialog(
                                    title: Text('Alert'),
                                    content: Text((_model
                                            .updateAlertsResponse2?.bodyText ??
                                        '')),
                                    actions: [
                                      TextButton(
                                        onPressed: () =>
