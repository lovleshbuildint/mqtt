...
import 'set_u_r_l_model.dart';
export 'set_u_r_l_model.dart';

class SetURLWidget extends StatefulWidget {
  const SetURLWidget({
    super.key,
...
class _SetURLWidgetState extends State<SetURLWidget>
    with TickerProviderStateMixin {
  late SetURLModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SetURLModel());

    _model.setUrl1TextController ??= TextEditingController(
        text: 'http://api.euronet.buildint.co/rawdatacreate');
    _model.setUrl1FocusNode ??= FocusNode();

    _model.setUrl2TextController ??= TextEditingController();
    _model.setUrl2FocusNode ??= FocusNode();
                        ...
                        children: [
                          Expanded(
                            child: Form(
                              ...
                              child: TextFormField(
                                controller: _model.setUrl1TextController,
                                focusNode: _model.setUrl1FocusNode,
                                textCapitalization: TextCapitalization.words,
                                textInputAction: TextInputAction.done,
                                obscureText: false,
                                decoration: InputDecoration(
                                  isDense: false,
                                  hintText: 'Enter URL 1',
                                ...
                                validator: _model.setUrl1TextControllerValidator
                                    .asValidator(context),
                              ),
                            ),
                          ),
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Expanded(
                            child: TextFormField(
                              controller: _model.setUrl2TextController,
                              focusNode: _model.setUrl2FocusNode,
                              textCapitalization: TextCapitalization.words,
                              textInputAction: TextInputAction.done,
                              obscureText: false,
                              decoration: InputDecoration(
                                isDense: false,
                                hintText: 'Enter URL 2',
                                hintStyle: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                      fontFamily: 'Poppins',
                              ...
                              validator: _model.setUrl2TextControllerValidator
                                  .asValidator(context),
                            ),
                          ),
                        ],
